...
const styles = `
  ...
  .animated-border::before {
    content: '';
    position: absolute;
    top: -4px; /* Tăng để background to hơn */
    left: -4px;
    right: -4px;
    bottom: -4px;
  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
      ...
      <div className="hidden sm:flex items-center justify-center space-x-4 p-2">
        <a href={siteMetadata.linkedin} className="w-14 h-14 flex items-center justify-center rounded-full hover:scale-125 transition-all ease duration-200 animated-border" aria-label="Reach out to me via LinkedIn" target="_blank">
          <LinkedinIcon className="w-8 h-8 fill-current text-dark dark:text-light" />
        </a>
        <a href={siteMetadata.twitter} className="w-14 h-14 flex items-center justify-center rounded-full hover:scale-125 transition-all ease duration-200 animated-border" aria-label="Reach out to me via Twitter" target="_blank">
          <TwitterIcon className="w-8 h-8 fill-current text-dark dark:text-light" />
        </a>
        <a href={siteMetadata.github} className="w-14 h-14 flex items-center justify-center rounded-full hover:scale-125 transition-all ease duration-200 animated-border" aria-label="Check my profile on Github" target="_blank">
