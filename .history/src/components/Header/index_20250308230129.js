  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
      ...
      <div className="hidden sm:flex items-center justify-center space-x-4 p-2">
        <a href={siteMetadata.linkedin} className="w-[60px] h-[50px] flex items-center justify-center rounded-full hover:scale-125 transition-all ease duration-200 animated-border" aria-label="Reach out to me via LinkedIn" target="_blank">
