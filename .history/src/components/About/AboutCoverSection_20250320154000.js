    ...
    >
      ...
      >
        ...
        <p className="font-medium mt-2 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed">
          “Act locally, impact globally” – Mọi hành động nhỏ bé tại địa phương đều có thể tạo nên sự thay đổi tích cực to lớn. Mỗi hành động cụ thể, mỗi kilôgam phế liệu được tái chế, mỗi tấn chất thải được xử lý an toàn đều giảm thiểu tác động tiêu cực đến môi trường, hạn chế ô nhiễm, tiết kiệm cũng như tái chế tài nguyên. Chúng ta không cần phải chờ đợi những giải pháp lớn lao từ bên ngoài, mà có thể bắt đầu từ chính những gì trong tầm tay. Ngay cả những hành động nhỏ nhất, khi được thực hiện với sự cam kết và ý thức, đều góp phần bảo vệ môi trường, xây dựng một tương lai bền vững, và lan tỏa thông điệp mạnh mẽ về trách nhiệm với nơi chúng ta sống.
          <br />
          “Act locally, impact globally” không chỉ là một khẩu hiệu mà còn phản ánh tinh thần trách nhiệm và tầm nhìn của Bảo Long Scrap trong các hoạt động kinh doanh của mình. Những gì chúng ta làm hôm nay sẽ đóng góp vào bức tranh lớn hơn của nhân loại, nơi sự hợp lực của nhiều cá nhân và tổ chức có thể tạo nên sự thay đổi mang tính toàn cầu. Mỗi bước đi hiện tại đều có thể trở thành nền tảng cho một tương lai tốt đẹp hơn.
          <br />
          <br />
          Bảo vệ môi trường không chỉ là yếu tố sống còn mà còn là chìa khóa then chốt, góp phần to lớn vào hành trình hội nhập và phát triển bền vững của mỗi doanh nghiệp. Mang trong mình sứ mệnh cao cả ấy, <strong>CÔNG TY TNHH BẢO LONG SCRAP</strong> ra đời, kiên định đồng hành cùng cộng đồng trong công cuộc bảo vệ thiên nhiên xanh mát. Với triết lý hợp tác đôi bên cùng thịnh vượng, chúng tôi cam kết mang đến cho quý khách hàng những dịch vụ môi trường xuất sắc nhất, kết hợp chất lượng vượt trội và chi phí tối ưu.
          <br />
          <span className="block mt-4 text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-black dark:text-yellow-300">
            “Hãy cùng sánh bước, chung tay kiến tạo một hành tinh xanh, vì một tương lai rực rỡ cho thế hệ mai sau!”
          </span>
        </p>
      </div>
    </section>
