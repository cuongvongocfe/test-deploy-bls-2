...
const CONTAINER_CLASSES = "group flex flex-col items-center text-dark dark:text-light";
const IMAGE_CONTAINER_CLASSES = "h-full rounded-xl overflow-hidden";
const IMAGE_CLASSES =
  "aspect-[4/3] w-full h-full object-cover object-center group-hover:scale-105 transition-all ease duration-300";
const CONTENT_CLASSES = "flex flex-col w-full mt-4";
const TAG_CLASSES =
  "uppercase text-accent dark:text-accentDark font-semibold text-xs sm:text-sm hover:text-accent/80 dark:hover:text-accentDark/80 transition-colors duration-300";
const TITLE_CLASSES = "font-semibold capitalize text-base sm:text-lg";
const TITLE_HIGHLIGHT_CLASSES =
  "bg-gradient-to-r from-accent/50 to-accent/50 dark:from-accentDark/50 dark:to-accentDark/50 bg-[length:0px_6px] group-hover:bg-[length:100%_6px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500";
const DATE_CLASSES = "capitalize text-gray dark:text-light/50 font-semibold text-sm sm:text-base";
