    ...
    <div className="fixed bottom-4 right-4 z-50">
      {isOpen ? (
        ...
        <button
          ...
          className="w-12 h-12 bg-blue-500 dark:bg-blue-700 text-white dark:text-black rounded-full flex items-center justify-center hover:bg-blue-600 dark:hover:bg-blue-800"
        >
          <svg
