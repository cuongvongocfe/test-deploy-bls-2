    ...
    <div className="relative px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      >
        ...
        <textarea
          ...
          rows={3}
          className="w-full max-w-5xl outline-none border-0 p-0 mx-0 focus:ring-0 placeholder:text-lg border-b border-gray-400 focus:border-gray-600 bg-transparent mb-6 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-gray-100"
        />
        <input
          type="submit"
          value="GỬI YÊU CẦU"
