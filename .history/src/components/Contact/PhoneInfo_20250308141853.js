    ...
    <div className="fixed bottom-4 right-4 z-50">
      {isOpen ? (
        ...
        <button
          ...
          className="w-16 h-16 bg-blue-500 dark:bg-blue-700 text-white rounded-full flex items-center justify-center hover:bg-blue-600 dark:hover:bg-blue-800"
        >
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            className="w-8 h-8" // Tăng kích thước logo
          >
            <path
              strokeLinecap="round"
