...
export default function PhoneInfo() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-50"> {/* Đổi sang left-4 */}
      {isOpen ? (
        ...
        <button
          ...
          className="w-20 h-20 bg-blue-500 dark:bg-blue-700 text-white rounded-full flex items-center justify-center hover:bg-blue-600 dark:hover:bg-blue-800" // Tăng kích thước nút
        >
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            className="w-12 h-12" // Tăng kích thước SVG
          >
            <path
              strokeLinecap="round"
