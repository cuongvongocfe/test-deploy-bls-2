    ...
    <div className="fixed bottom-4 left-4 z-50">
      ...
      <div className="flex items-center">
        ...
        {isOpen ? (
          ...
          <div className="flex items-center">
            {/* Nút điện thoại với background gradient */}
            <button
              onClick={() => setIsOpen(true)}
              className="w-20 h-20 rounded-full flex items-center justify-center hover:scale-105 transition-all ease duration-200 relative overflow-hidden"
              style={{
