...
<div className="space-y-6">
  <h3 className="text-3xl font-bold text-center md:text-left text-orange-500 dark:text-orange-400 drop-shadow-lg">
    Dịch Vụ
  </h3>
  <div className="space-y-4">
    {Services.map((service, index) => (
      <a
        key={service}
        href="/"
        className={`${styles.serviceItem} block text-[22px] font-semibold text-dark dark:text-gray-100 bg-gray-100 dark:bg-gray-800 py-3 px-5 rounded-lg shadow-md hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-600 hover:text-white hover:scale-105 transform transition-all duration-300 ease-in-out`}
