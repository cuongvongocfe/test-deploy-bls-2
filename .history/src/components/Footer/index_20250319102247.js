    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-7 pt-5 font-medium">
          {SkillList.map((item) => (
            <li
              ...
              style={{
                backgroundColor: "#F4A261", // accentDark: Cam đào
                color: "#2F1B41", // dark: Tím đen đậm
                border: "2px solid #D4A5A5", // accent: Hồng đào
              }}
            >
              {item}
            </li>
        ...
        <div
          ...
          style={{ borderTop: `1px solid #8D5524` }} // gray: Nâu đậm
        >
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                style={{ color: "#D4A5A5" }} // accent: Hồng đào
              >
                📞 (+84) 87.6789.252
              </a>
              <a
                ...
                style={{ color: "#F4EDEA", hover: { color: "#F4A261" } }} // light: Hồng phấn nhạt, hover cam đào
              >
                info@baolongscrap.vn
              </a>
              <p
                className="text-xl font-medium"
                style={{ color: "inherit" }} // Màu mặc định (hồng phấn nhạt từ text cha)
              >
          ...
          <div className="space-y-4">
            ...
            >
              <input
                ...
                style={{
                  backgroundColor: "#F4EDEA", // light: Hồng phấn nhạt
                  color: "#2F1B41", // dark: Tím đen đậm
                  border: `1px solid #8D5524`, // gray: Nâu đậm
                  focus: { ring: `2px solid #D4A5A5` }, // accent: Hồng đào khi focus
                }}
              />
              <div
                className="max-h-[250px] overflow-y-auto pr-2 scrollbar-thin"
                style={{
                  scrollbarThumb: "#D4A5A5", // accent: Hồng đào
                  scrollbarTrack: "#8D5524", // gray: Nâu đậm
                }}
              >
                <ul className="space-y-3">
                  {filteredServices.length > 0 ? (
                    ...
                    <li
                      ...
                      style={{ color: "#8D5524" }} // gray: Nâu đậm
                    >
          ...
          <div className="w-full max-w-md mx-auto md:max-w-xs lg:max-w-sm">
            <iframe
              ...
              width="100%"
              height="300"
              style={{ border: `2px solid #F4A261` }} // accentDark: Cam đào
              allowFullScreen=""
              loading="lazy"
        ...
        <div
          ...
          style={{ borderTop: `1px solid #8D5524`, color: "#8D5524" }} // gray: Nâu đậm
        >
