...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      <div className="grid lg:grid-cols-6 mt-7 sm:grid-cols-3 grid-cols-2 items-center  gap-8 lg:px-24 px-4 pt-5 w-full  md:mt-24 relative font-medium dark:font-bold border-t border-solid border-light py-6   flex-col md:flex-row  justify-between">
