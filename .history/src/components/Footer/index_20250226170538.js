...
const Footer = () => {
  ...
  return (
    <footer className="mt-5 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      <h3 className="mt-5 font-bold text-center capitalize text-2xl sm:text-3xl lg:text-4xl px-4 dark:font-extrabold">
        UY TÍN TẠO NIỀM TIN
      </h3>
      <p className="mt-3 px-4 text-center w-full sm:w-3/5 font-light dark:font-extrabold text-sm sm:text-base">
        "Act locally, impact globally"
      </p>
      <div className='grid lg:grid-cols-12 mt-1 sm:grid-cols-3 grid-cols-2 items-center  gap-8 lg:px-24 px-4 pt-5' >
      ...
      <div className="w-full  flex items-center mt-16 md:mt-24 relative font-medium dark:font-bold border-t border-solid border-light py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
