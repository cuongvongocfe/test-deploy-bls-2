...
import partner7 from "../../../public/blogs/437845797_951474690315138_3562695810624570594_n.jpg";
...
const SkillList = [
  ...
  // "SÀI GÒN  RẠCH GIÁ HOTEL",
  // "HÒA BÌNH RẠCH GIÁ RESORT",
  // "SIÊU THỊ MEGA MARKET RẠCH GIÁ",
  // "BỆNH VIỆN Y DƯỢC CỔ TRUYỀN TỈNH KIÊN GIANG",
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      <div className="grid lg:grid-cols-6 mt-7 sm:grid-cols-3 grid-cols-2 items-center  gap-8 lg:px-24 px-4 pt-5">
        ...
        <Image className="border-radius" src={partner1} width="30px" height="30px"></Image>
        <Image className="" src={partner7} width="30px" height="30px"></Image>
        
      </div>

      <ul className="grid lg:grid-cols-6 mt-7 sm:grid-cols-2 grid-cols-2 items-center  gap-8 lg:px-24 px-4 pt-5">
