    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-7 pt-5 font-medium">
          {SkillList.map((item) => (
            <li
              ...
              style={{
                backgroundColor: "#F5F5DC", // Tone lạnh: Vàng nhạt ánh xanh
        ...
        >
          ...
          <div className="space-y-3 flex-1">
            ...
            <div
              ...
              }`} // Giảm max-height để cân đối với phần Liên Hệ
            >
              <input
                type="text"
          ...
          <div className="w-full max-w-md mx-auto md:max-w-xs lg:max-w-sm flex-1">
            <iframe
              ...
              width="100%"
              height="300"
              style={{ border: `2px solid #F5F5DC` }} // Tone lạnh: Vàng nhạt ánh xanh
              allowFullScreen=""
              loading="lazy"
        ...
        <div
          ...
          style={{ borderTop: `1px solid #64748B`, color: "#E0F2FE" }}
        >
