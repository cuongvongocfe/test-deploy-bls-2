...
const Footer = () => {
  ...
  const [showInfoModal, setShowInfoModal] = useState(false); // Trạng thái để hiển thị modal
  ...
  const sliderSettings = {
    ...
    responsive: [
      ...
      {
        breakpoint: 480, // Thêm breakpoint cho màn hình nhỏ hơn
        settings: {
          slidesToShow: 1,
        },
      },
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {Partners.map((partner, index) => (
              <div key={index} className="px-4 flex items-center justify-center h-[200px]">
                <Image
                  ...
                  style={{ maxHeight: "150px", maxWidth: "200px" }} // Điều chỉnh kích thước để logo rõ hơn
                />
              </div>
            ))}
          </Slider>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="block text-xl font-medium cursor-pointer transition-colors duration-200"
                style={{ color: "#F5F5F5" }} // Đổi màu thành trắng (#F5F5F5)
              >
        ...
        {showInfoModal && (
          <div
            ...
            onClick={toggleInfoModal} // Nhấp ra ngoài để đóng
          >
            <div
              ...
              style={{ backgroundColor: "#F5F5F5" }} // light: Xám trắng nhạt
            >
              <button
                onClick={toggleInfoModal}
                ...
                style={{ backgroundColor: "#C7A17A" }} // accent: Nâu cam nhạt
              >
                ✕
              </button>
              <h3
                className="text-2xl font-bold mb-4 text-center"
                style={{ color: "#1C2526" }} // dark: Xám đen đậm
              >
                Thông Tin Công Ty
              </h3>
              <div className="space-y-2">
                <p style={{ color: "#1C2526" }}>
        ...
        <div
          ...
          style={{ borderTop: `1px solid #6B7280`, color: "#F5F5F5" }} // Đổi màu thành trắng (#F5F5F5)
        >
