...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-[#1e3b17] dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      <div className="w-full  flex items-center mt-16 md:mt-24 relative font-medium dark:font-bold border-t border-solid border-light py-6 px-8 flex-col md:flex-row items-center justify-between text-slate-950">
