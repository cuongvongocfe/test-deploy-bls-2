        ...
        <div className="mt-8 pt-5">
          <Slider {...sliderSettings}>
            {Partners.map((partner, index) => {
              ...
              const isSmaller = index === 4 || index === 6; // Kiểm tra partner5 và partner7
              const imageHeight = isSmaller ? "120px" : "150px"; // Chiều cao nhỏ hơn cho partner5 và 7
              ...
              return (
                <div key={index} className="px-4 flex items-center justify-center h-[200px]">
                  <Image
                    ...
                    style={{ height: imageHeight, width: "auto" }} // Ép chiều cao cố định
                  />
                </div>
              );
            })}
