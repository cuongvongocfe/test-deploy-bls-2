...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: "#1E3A8A" }} // Tone lạnh: Xanh dương đậm
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          style={{ borderTop: `1px solid #64748B` }} // Tone lạnh: Xám lạnh
        >
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center text-lg font-medium transition-colors duration-200 hover:text-#93C5FD"
                style={{ color: "#60A5FA" }} // Tone lạnh: Xanh dương sáng
              >
              ...
              <a
                ...
                className="flex items-center text-lg font-medium cursor-pointer transition-colors duration-200 hover:text-#93C5FD"
                style={{ color: "#E0F2FE" }}
              >
          ...
          <div className="space-y-4">
            ...
            >
              <input
                ...
                style={{
                  backgroundColor: "#E0F2FE", // Tone lạnh: Trắng ánh xanh
                  color: "#0F172A", // Tone lạnh: Đen ánh xanh
                  border: `1px solid #64748B`, // Tone lạnh: Xám lạnh
                }}
              />
              <div
                className="max-h-[250px] overflow-y-auto pr-2 scrollbar-thin"
                style={{
                  scrollbarThumb: "#60A5FA", // Tone lạnh: Xanh dương sáng
                  scrollbarTrack: "#64748B", // Tone lạnh: Xám lạnh
                }}
              >
                <ul className="space-y-3">
                  {filteredServices.length > 0 ? (
                    ...
                    <li
                      ...
                      style={{ color: "#64748B" }} // Tone lạnh: Xám lạnh
                    >
          ...
          <div className="w-full max-w-md mx-auto md:max-w-xs lg:max-w-sm">
            <iframe
              ...
              width="100%"
              height="300"
              style={{ border: `2px solid #60A5FA` }} // Tone lạnh: Xanh dương sáng
              allowFullScreen=""
              loading="lazy"
        ...
        {showInfoModal && (
          ...
          >
            <div
              ...
              style={{ backgroundColor: "#E0F2FE" }} // Tone lạnh: Trắng ánh xanh
            >
              <button
                onClick={toggleInfoModal}
                ...
                style={{ backgroundColor: "#60A5FA" }} // Tone lạnh: Xanh dương sáng
              >
                ✕
              </button>
              <h3
                className="text-2xl font-bold mb-4 text-center"
                style={{ color: "#0F172A" }} // Tone lạnh: Đen ánh xanh
              >
                Thông Tin Công Ty
              </h3>
              <div className="space-y-2">
        ...
        <div
          ...
          style={{ borderTop: `1px solid #64748B`, color: "#E0F2FE" }} // Tone lạnh: Xám lạnh và trắng ánh xanh
        >
