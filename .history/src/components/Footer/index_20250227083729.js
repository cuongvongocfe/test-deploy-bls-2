...
{/* text */}
        <div className="space-y-3 text-gray-300 mt-16 ">
            <a
              href="/"
              className=" relative block text-[20px] items-center rounded-3xlfont-bold"
            >
            ...
            <a
              href="/"
              className=" relative block text-[20px] items-center rounded-3xlfont-bold text-stone-50"
            >
