...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: "#1E40AF" }} // Tone lạnh: Xanh dương đậm, tương phản tốt với logo
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3
          className="mt-8 font-bold text-center capitalize text-2xl sm:text-3xl lg:text-4xl"
          style={{ color: "#E0F2FE" }} // Tone lạnh: Trắng ánh xanh
        >
            ...
            {Partners.map((partner, index) => (
              <div key={index} className="px-4 flex items-center justify-center h-[200px]">
                <Image
                  ...
                  style={{ maxHeight: "150px", maxWidth: "200px", filter: "brightness(1.2)" }} // Tăng độ sáng để logo rõ hơn
                />
              </div>
            ))}
          </Slider>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-7 pt-5 font-medium">
          {SkillList.map((item) => (
            <li
              ...
              style={{
                backgroundColor: "#93C5FD", // Tone lạnh: Xanh dương nhạt
                color: "#0F172A", // Tone lạnh: Đen ánh xanh
                border: "2px solid #60A5FA", // Tone lạnh: Xanh dương sáng
              }}
            >
              {item}
            </li>
        ...
        <div className="mt-8 md:mt-12 py-6 grid grid-cols-1 md:grid-cols-3 gap-8" style={{ borderTop: `1px solid #64748B` }}>
          <div className="space-y-4">
            <h3 className="text-3xl font-semibold" style={{ color: "#E0F2FE" }}>
              Liên Hệ
            </h3>
            <div className="space-y-2 text-lg font-medium" style={{ color: "#E0F2FE" }}>
              <p className="flex items-center"><span className="mr-2">📞</span> (+84) 87.6789.252</p>
              <p className="flex items-center"><span className="mr-2">📧</span> info@baolongscrap.vn</p>
              <p className="flex items-center"><span className="mr-2">📜</span> Mã Số Thuế: 1702260628</p>
              <p className="flex items-center"><span className="mr-2">📍</span> A17-36A Đường Số 02, Khu Nam An Hòa, Phường An Hòa, Thành Phố Rạch Giá, Tỉnh Kiên Giang</p>
            </div>
          </div>
              ...
              >
                <ul className="space-y-3">
                  {filteredServices.length > 0 ? (
                    ...
                    <li className="text-[20px] font-bold" style={{ color: "#64748B" }}>
        ...
        {showInfoModal && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 text-center" style={{ color: "#0F172A" }}>
                Thông Tin Công Ty
              </h3>
              <div className="space-y-2">
                <p style={{ color: "#0F172A" }}><strong>CÔNG TY TNHH BẢO LONG SCRAP</strong></p>
                <p style={{ color: "#0F172A" }}><strong>Tên giao dịch:</strong> BLS.COM</p>
                <p style={{ color: "#0F172A" }}><strong>Số ĐKKD/MST:</strong> 1702260628</p>
                <p style={{ color: "#0F172A" }}><strong>Ngày cấp:</strong> 15/08/2022</p>
                <p style={{ color: "#0F172A" }}><strong>Ngày hoạt động:</strong> 15/08/2022</p>
                <p style={{ color: "#0F172A" }}><strong>Tình trạng:</strong> Đang Hoạt Động</p>
                <p style={{ color: "#0F172A" }}><strong>Địa chỉ:</strong> A17-36A Đường Số 02, Khu Nam An Hòa, Phường An Hòa, Thành Phố Rạch Giá, Kiên Giang</p>
                <p style={{ color: "#0F172A" }}><strong>Người đại diện:</strong> Lê Thanh Duy</p>
                <p style={{ color: "#0F172A" }}><strong>Điện thoại:</strong> 0876789252</p>
                <p style={{ color: "#0F172A" }}><strong>Email:</strong> thanhduyqdtp@gmail.com</p>
                <p style={{ color: "#0F172A" }}><strong>Loại hình DN:</strong> Công Ty TNHH 2 TV Trở Lên Ngoài Quốc Doanh (100% Vốn Tư Nhân)</p>
                <p style={{ color: "#0F172A" }}><strong>Ngành nghề KD:</strong> Thu Gom Rác Thải Không Độc Hại</p>
              </div>
            </div>
          </div>
        )}

        <div className="py-4 text-center text-sm" style={{ borderTop: `1px solid #64748B`, color: "#E0F2FE" }}>
