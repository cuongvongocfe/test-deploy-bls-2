...
const Footer = () => {
  ...
  <h3 className="text-2xl font-semibold text-dark dark:text-white tracking-tight">
    Dịch Vụ
  </h3>
  <div className="space-y-3">
    {Services.map((service) => (
      <a
        key={service}
        href="/"
        className="block text-xl font-medium text-dark dark:text-gray-200 py-2 px-4 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-orange-600 dark:hover:text-orange-400 transition-all duration-200 ease-in-out"
      >
        {service}
      </a>
    ))}
